import { assert, log } from "../qut";
import { inputSys } from "./main";
...
export function setup() {
  log("Setting up virtual joystick...");
...
function setUpButton(buttonId: string, buttonKeyName: string) {
  const button = assert(document.getElementById(buttonId),
...
function handleButtonEvent(buttonKeyName: string, down: boolean, evt: KeyboardEvent | MouseEvent | TouchEvent) {
